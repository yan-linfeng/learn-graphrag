...
from . import OracleAIVectorSearch
...
class VectorStoreType(str, Enum):
    ...
    OracleAIVectorSearch = "oracle_ai_search"
...
class VectorStoreFactory:
    ...
    def get_vector_store(
    ...
    ) -> LanceDBVectorStore | AzureAISearch | OracleAIVectorSearch:
        ...
        match vector_store_type:
            ...
            case VectorStoreType.OracleAIVectorSearch:
                return OracleAIVectorSearch(**kwargs)
            case _:

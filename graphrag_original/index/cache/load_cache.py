...
from graphrag_original.config.enums import CacheType
from graphrag_original.index.config.cache import (
    PipelineBlobCacheConfig,
    PipelineFileCacheConfig,
)
from graphrag_original.index.storage import BlobPipelineStorage, FilePipelineStorage

if TYPE_CHECKING:
    from graphrag_original.index.config import (
        PipelineCacheConfig,
    )

...
class LLMParameters(BaseModel):
    ...
    model_id: str = Field(description="The LLM model id to use.", default=defs.LLM_MODEL_ID)
    ...
    top_k: int | None = Field(
        description="The top-k value to use for token generation.",
    ...
    endpoint: str | None = Field(
        description="The endpoint URL for the LLM API.", default=None
    )
    ...
    config_profile: str | None = Field(
        description="The config profile to use for the LLM service.", default=None
    )
    compartment_id: str | None = Field(
        description="The compartment to use for the LLM service.", default="DEFAULT"
    )

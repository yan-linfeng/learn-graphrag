...
def get_token_counter(config: OCIGenAIConfiguration) -> Callable[[str], int]:
...
def get_completion_cache_args(configuration: OCIGenAIConfiguration) -> dict:
...
def get_completion_llm_args(
    parameters: dict | None, configuration: OCIGenAIConfiguration
) -> dict:
